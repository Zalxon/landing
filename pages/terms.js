      ...
      <Row>
        <Column start={[2, 2, 3, 3]} width={[5, 5, 6, 6]}>
          ...
          >
            ...
            <Link href='https://github.com/zalxon'>GitHub</Link>.
          </Box>
          <Box as='p' variant='styles.p'>
            Consistent with our health mission to build open tools and
            resources for the evaluation and deployment of health solutions, we
          ...
          <Box as='p' variant='styles.p'>
            ...
            <Link href={`mailto:${app.email}`}>{app.email}</Link>
            .
          </Box>
        </Column>
      </Row>
