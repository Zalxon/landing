...
const Sidenote = () => {
  return (
    <span>
      ...
      <Link href='mailto:hello@zalxon.com'>Email us</Link>.
    </span>
  )
}
...
const getMessage = (amount) => {
  ...
  if (Number(amount) < 1) {
    ...
    message = (
      <span>
        <Link href='mailto:hello@zalxon.com' sx={{ color: 'teal' }}>
          Email us
        </Link>{' '}
      ...
      <Row>
        ...
        >
          ...
          >
            ...
            healthcare. Our team will do our best to do right by your generosity.
          </Box>
        </Column>
      </Row>
      <Row>
