...
import { Layout, Row, Column, Heading, Avatar } from '@zalxon/components'
import AnnotatedTable from '../components/annotated-table'
import { app, team, board, collaborators } from '../data'
      ...
      <Heading
        sidenote={
          <span>
            ...
            <Link href='https://zalxon.com/jobs'>job openings</Link>.
          </span>
        }
      >
        Team
      ...
      <AnnotatedTable
        ...
        sidenote={
          <span>
            ...
            <Link href={`mailto:${app.email}`}>Email us</Link>.
          </span>
        }
      />
    </Layout>
